        ...
        static void ProcessByAction(string action, string xlsxPath, Dictionary<string, string> extraParameters, string ignoreDuplicates, NLog.Logger logger)
        {
            switch (action)
            {
                ...
                case "importcompanydirectives":
                    ...
                    break;
                case "importcontractresourceleasing":
                    EntityProcessor.Process(typeof(ContractResourceLeasing), xlsxPath, Constants.SheetNames.ContractResourceLeasing, extraParameters, ignoreDuplicates, logger);
                    break;
                case "importcontractresourceallocation":
                    EntityProcessor.Process(typeof(ContractResourceAllocation), xlsxPath, Constants.SheetNames.ContractResourceAllocation, extraParameters, ignoreDuplicates, logger);
                    break;
                default:
                    break;
            }

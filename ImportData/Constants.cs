...
namespace ImportData
{
  class Constants
  {
    ...
    public class SheetNames
    {
      ...
      public const string ContractResourceLeasing = "АрендаРесурсов";
      public const string ContractResourceAllocation = "РазмещениеРесурсов";
    }
    ...
    public class Actions
    {
      ...
      public const string ImportContractResourceLeasing = "importcontractresourceleasing";
      public const string ImportContractResourceAllocation = "importcontractresourceallocation";
      ...
      public static Dictionary<string, string> dictActions = new Dictionary<string, string>
      {
        ...
        {ImportContractResourceLeasing, ImportContractResourceLeasing},
        {ImportContractResourceAllocation, ImportContractResourceAllocation}
      };
    }
